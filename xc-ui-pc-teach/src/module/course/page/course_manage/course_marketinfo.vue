  ...
  <div>
    <el-form :model="courseMarketForm" label-width="110px" :rules="courseMarketFormRules" ref="courseMarketForm">
      <el-form-item label="课程价格" prop="charge">
        ...
        <br/>
        金额（元）：
        <el-input :disabled="this.courseMarketForm.charge!=='203002'" v-model="courseMarketForm.price"></el-input>
      </el-form-item>
      <el-form-item label="课程有效期" prop="expires">
        ...
        <br/>
        开始时间：
        <el-date-picker :disabled="this.courseMarketForm.valid!=='204002'" type="date" placeholder="选择日期"
