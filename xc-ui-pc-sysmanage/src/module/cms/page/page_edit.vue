<template>
  <div>
    <el-form style="margin-top: 10px" :model="pageForm" label-width="80px" :rules="pageFormRules" ref="pageForm">
      ...
      <el-form-item label="选择模版" prop="templateId">
        <el-select v-model="pageForm.templateId" clearable placeholder="请选择模板">
          <el-option
