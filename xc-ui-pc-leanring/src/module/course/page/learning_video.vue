                ...
                <div class="note-item-cont">
                  <div class="my-note">
                    <div class="textarea-box">
                      <textarea name="my-note"></textarea>
            ...
            <div class="navCont">
              <div class="course-weeklist">
                <div class="nav nav-stacked" v-for="(teachplan_first, index) in teachplanList">
                  <div class="tit nav-justified text-center"><i
                    class="pull-left glyphicon glyphicon-th-list"></i>{{ teachplan_first.pname }}<i
                  ...
                  <li v-if="teachplan_first.children!=null"
                    ...
                    <a :href="media_url+teachplan_second.id"
                       @click="study(teachplan_second.id)">
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      this.media_url = this.url.origin + "#/learning/" + this.courseId + "/"
      // 章节id
